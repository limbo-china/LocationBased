...
public class DataProServer {
	...
	private static void init() throws Exception {
		...
		if (serverIP.isEmpty()) {
			throw new Exception("definition jettyServerIP is not found in "
					+ configurationFileName);
		}
		...
		ContextHandler dataProvinceQueryContext = new ContextHandler(
				"/provincequery");
		DataProvinceQueryHandler dataProvinceQueryHandler = DataProvinceQueryHandler
				.getHandler();
		...
		DataSQLQueryHandler dataSQLQueryHandler = DataSQLQueryHandler
				.getHandler();
		...
		DataSubConfigHandler dataSubSconfigHandler = DataSubConfigHandler
				.getHandler();
		...
		contexts.setHandlers(new Handler[] { dataProvinceQueryContext,
				dataSQLQueryContext, dataDetailQueryContext,
				dataSubSconfigContext });
