...
public class GetTraceData3 {
	...
	static {
			...
			PropertyConfigurator.configure("log4j.properties");
				logger = Logger.getLogger(GetTraceData3.class.getName());
		try {
...
//					BufferedWriter bufferWritter = new BufferedWriter(fileWritter);
				 ...
				 sql= "select * from T_LBS_TRACE_HISTORY where C_TIMESTAMP >=unix_timestamp('2018-05-12 00:00:00') and  C_TIMESTAMP < unix_timestamp('2018-05-13 24:00:00') and ("+msisdntmp+") order by C_TIMESTAMP desc;";	
