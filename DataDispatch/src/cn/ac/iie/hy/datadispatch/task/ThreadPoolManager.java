...
public final class ThreadPoolManager {
	...
	private static ThreadPoolManager sThreadPoolManager2 = new ThreadPoolManager();
	...
	// 线程池维护线程所允许的空闲时间
	private static final int TIME_KEEP_ALIVE = 10000;

	// 线程池所使用的缓冲队列大小
	private static final int SIZE_WORK_QUEUE = 1000;

	// 任务调度周期
	private static final int PERIOD_TASK_QOS = 500;
	...
	public static ThreadPoolManager newInstance2() {
		return sThreadPoolManager2;
	}
	...
	public final void printThreadPoolQueueSize(){
		
		logger.info("mTaskQueue: "+mTaskQueue.size()
		+" mThreadPool: "+mThreadPool.getQueue().size()+" "+mThreadPool.getTaskCount()+" "+mThreadPool.getPoolSize());
	}
