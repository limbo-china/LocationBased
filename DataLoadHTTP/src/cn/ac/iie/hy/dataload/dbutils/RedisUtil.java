 ...
 */
package cn.ac.iie.hy.dataload.dbutils;
...
public class RedisUtil {
	...
	static {
		...
		if (conf == null) {
			System.out.println("reading " + configurationFileName
					+ " is failed.");
			System.exit(-1);
		}

		String ADDR = conf.getString("redisIP", "").split(":")[0];
		PORT = Integer.parseInt(conf.getString("redisIP", "").split(":")[1]);
		if (ADDR.isEmpty()) {
			System.out.println("definition redisIP is not found in "
