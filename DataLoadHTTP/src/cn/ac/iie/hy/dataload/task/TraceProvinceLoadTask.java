...
public class TraceProvinceLoadTask implements Runnable{
    ...
    public TraceProvinceLoadTask(int batchCount, long timeInternal, String url, String schemaName) {
		super();
...
//            }
	...
	public static void main(String[] argv){
		TraceProvinceLoadTask task = new TraceProvinceLoadTask (1, 1, "http://127.0.0.1:8010/dataload/?region=ppp", "t_lbs_trace_history");
