...
public final class ThreadPoolManager {
	...
	public String getPoolInfo(){
		//return "succ task : " + mThreadPool.getCompletedTaskCount() + mThreadPool.
		return "active count: " + mThreadPool.getActiveCount() + " pool size: " + mThreadPool.getPoolSize() + " queue size: "+ mThreadPool.getQueue().size();
	}
